...
TIER_DEFINITIONS: dict[str, dict] = {
    ...
    "pay_per_document": {
        ...
        "description": "Generate one document — no subscription needed",
        ...
        "compliance_alerts": False,
        "allowed_templates": ["cac_checklist", "employment_contract", "nda", "service_agreement"],
        "features": ["Single document generation"],
    },
    "pay_per_contract_review": {
        "name": "Contract Review (Pay-per-use)",
        "description": "AI + lawyer review for one contract — no subscription",
        "billing_type": "one_time",
        "price_ngn": 5_000,
        "matter_limit": 0,
        "document_limit": 0,
        ...
        "compliance_alerts": False,
        "allowed_templates": [],
        "features": ["Single AI contract review + lawyer annotation"],
    },
}
